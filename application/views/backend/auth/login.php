              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="text-gray-900 mb-4">E-Klaim</h1>
                    <?php $this->view('messages') ?>
                  </div>
                  <form action="" method="post" class="user">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail"
                        aria-describedby="emailHelp" autocomplete="off" placeholder="Enter Email Address...">
                  ...
                  <hr>
                  <!-- <div class="text-center">
                    <a class="small" href="<?= site_url('auth/forgotpassword') ?>" style="text-decoration: none">Lupa
                      Password ?</a>
                  </div> -->
                </div>
              </div>
